cdef extern from "<timedata_visualizer/base/timestamp.h>" namespace "timedata":
...
def print_startup_message():
    """Print a string with the startup message.
       ...
       environment variable TIMEDATA_VISUALIZER_SILENT_STARTUP."""
    import os
    if not os.environ.get('TIMEDATA_VISUALIZER_SILENT_STARTUP'):
        print('timedata_visualizer: compiled', compile_timestamp(),
              '; tags', git_tags())
